            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <form method="POST" action ="/company/{{ $company->id }}" enctype="multipart/form-data">
                    ...
                    <div class="w-4/5 m-5">
                        ...
                        <label for="description" class="inline-block w-3/12 text-center font-bold m-5 text-2xl align-top">Descriptie:</label> 
                        ...
                        <p class="inline-block w-3/12 text-center font-bold m-5 text-2xl">Stage type:</p> 
